...
//Ex1-
let receitasSemGorjeta = 0
for (let vendas of receita){
    receitasSemGorjeta = receitasSemGorjeta + vendas.valor
}
console.log("O valor total de vendas sem incluir a gorjeta foi de: R$",receitasSemGorjeta)

//ex2-
let valorFinal = 0
const receitasComGorjeta = (valor, gorjeta)=>{
    let soma = valor + gorjeta
    return soma
}
for (let vendas_a of receita){
    //console.log(receitasComGorjeta (vendas_a.valor, vendas_a.gorjeta) )
    valorFinal=valorFinal + receitasComGorjeta (vendas_a.valor, vendas_a.gorjeta)
}
console.log("O valor total de vendas incluindo a gorjeta foi de: R$",valorFinal)
//outra forma de fazer:
/*
let receitasComGorjeta = 0
for (let vendas_a of receita){
    receitasComGorjeta = receitasComGorjeta + vendas_a.valor + vendas_a.gorjeta
}
console.log(receitasComGorjeta)
*/

//ex3-
let pechincha = 0
for (let vendas_b of receita){
    if (vendas_b.valor < 50){
        pechincha++
    }    
}
console.log("No total, ",pechincha, " vendas foram abaixo de 50 reais")